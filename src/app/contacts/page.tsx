...
export default function ContactPage() {
  return (
    <div className="bg-black bg-cover bg-no-repeat">
      <div className="bg-contactBg flex w-full flex-col items-center justify-center bg-cover bg-no-repeat py-32">
        <div className="relative mt-12 flex flex-col items-center justify-center gap-3">
