        ...
        <div className="relative flex flex-col items-center justify-center gap-14 text-white">
          ...
          <div className="flex flex-col items-center justify-center gap-10 lg:text-2xl">
            ...
            <div className="flex flex-wrap gap-20">
              <div className="flex flex-col items-center justify-center gap-2 lg:gap-5 lg:min-w-[429px]">
              ...
              <div className="flex flex-col items-start justify-center gap-2 lg:gap-5 lg:min-w-[429px]">
          ...
          <button className="rounded-sm border mt-4 border-white bg-white px-5 py-2 text-2xl font-medium uppercase text-black hover:bg-custom-black hover:text-white hover:duration-700">
            Зв'язатись з нами
          </button>
        </div>
      </div>
