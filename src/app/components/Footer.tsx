      ...
      <h3 className="relative text-center text-xl font-semibold uppercase md:text-2xl lg:text-3xl">
        <span className="text-white">
          {t.rich('responsibleConsumption', {
            hl: (chunks) => <span className="text-yellow">{chunks}</span>,
          })}
        </span>
      </h3>

      <div className="relative z-50 flex flex-col items-center justify-around gap-10 p-4 lg:flex-row lg:flex-wrap">
