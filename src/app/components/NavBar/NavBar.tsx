...
const NavBar: React.FC = () => {
  ...
  return (
    <nav
      className={`relative z-40 flex justify-between items-center uppercase w-full py-4 px-6 bg-black text-white xl:px-12 lg:px-4 lg:py-14 text-xl 2xl:text-2xl  ${css.shimmerBorder}`}
    >
